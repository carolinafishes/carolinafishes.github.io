...
<br>
<br>
Note that BUSCO is limited to UNIX (Mac and Linux) systems, so you can only use the download and sequence extraction functions relying on BUSCO in Unix (Mac and Linux) systems. Missing data visualizations will work on all platforms. 
<br>
<br>
